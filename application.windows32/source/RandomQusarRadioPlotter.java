...
public class RandomQusarRadioPlotter extends PApplet {
...
public float distro(float x, float mid) // distributes higher peaks towards the center (x is the point coordinate, mid is the middle of the screen)
{
  float clamp = 50;
...
public void display()
{
  ...
  float step = PApplet.parseFloat(width / xloop); // finds how far apart on the x axis curve points should be to be spread evenly
...
public void keyPressed()
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "RandomQusarRadioPlotter" };
    if (passedArgs != null) {
